...
_Figure: DOB Protocol trusts verified performance, not credit score._
...
✅ Native DeFi integration: tokens compatible with AMMs, lending pools, and vaults from day one
...
_Figure: eHive project card showing APY and pool balance._
...
_Figure: DOB Protocol Business Model overview._
...
## WHO IT'S FOR: Buyer Personas### Project Owners
...
_Figure: Pre-seed round allocation breakdown._

***

## PROJECTIONS

_Figure: Market opportunity projections - TAM, SAM, SOM._
...
*   **December:** Accepted into Uniswap Hook Incubator | Hosted DOB Machine Day 2025
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>DOB Protocol is built in the open and with the community. We work closely with Stellar, Draper U, Tellus Cooperative and regional partners across Latin America to scale adoption, compliance, and on-chain interoperability. Our stacks bridge Base (where Investment Rounds are deployed) and Stellar (where DeFi reinvestment and interoperability happen), creating a cross-chain flow that multiplies capital efficiency.</p></div>
...
*   **Meridian Conference:** Presentation at Stellar's flagship conference
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>### VISION</p></div>
...
## NEXT STEPS & CONTACT### For Project Owners
...
*   DOB Protocol Mission, Vision & Values
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p><strong>Legal Notice and Risk Disclaimer</strong></p></div>
