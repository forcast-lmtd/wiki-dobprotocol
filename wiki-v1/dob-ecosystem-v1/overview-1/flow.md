...
{% hint style="info" %}
In the future, this process will be automated with AI Agents and the $DOBI token.
{% endhint %}

### 3. **Machine Score**

<figure><img src="../../../.gitbook/assets/Risk score (LinkedIn).png" alt=""><figcaption></figcaption></figure>

The project receives a **Machine Score**, a metric that reflects how trustworthy, evidence-backed, and investment-ready the infrastructure is. This score is based on:
