...
{% hint style="danger" %}
No machine can access capital on Dobprotocol without going through Dob Validator.
{% endhint %}
...
Want to try it? [Visit Dob Validator](https://validator.dobprotocol.com/).
